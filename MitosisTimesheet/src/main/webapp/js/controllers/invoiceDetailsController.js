		...
		if($scope.member.rateperhour){
			...
			if(lastnum=="."){
				...
				if($scope.member.billablehours){
					...
					$scope.member.amount = parseFloat($scope.member.rateperhour*$scope.member.billablehours);
	...
	$scope.amountCalForUpdate = function (sheet){
		...
		if(sheet.rateperhour){
			...
			if(lastnum=="."){
				...
				if(sheet.billablehours){

					sheet.amount = parseFloat(sheet.rateperhour*sheet.billablehours);
				...
				else if(sheet.billablehours==undefined || sheet.billablehours=="" || isNaN(sheet.billablehours)){
