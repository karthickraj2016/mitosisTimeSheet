...
public class TimeSheetDAOImpl extends BaseService implements TimeSheetDAO{
	...
	public List<ProjectModel> getprojectList(Object userId) {
		...
		List<TeamAssignmentModel> teamAssignList = new ArrayList<TeamAssignmentModel>();
		...
		try{
			...
			for(TeamAssignmentModel teamassignment : teamAssignList){
				
				projectModel.add(teamassignment.getProject());
			}
